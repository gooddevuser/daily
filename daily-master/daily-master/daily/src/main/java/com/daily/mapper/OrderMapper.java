...
public interface OrderMapper {
	...
	int selectOrderByTotalPrice(int ono);
	...
	int selectSumSalepriceBy10Day();
	int selectSumSalepriceBy11Day();
	int selectSumSalepriceBy12Day();
	...
	int selectAvgSalepriceBy10Day();
	int selectAvgSalepriceBy11Day();
	int selectAvgSalepriceBy12Day();
	...
	int selectSumRefundSalepriceBy10Day();
	int selectSumRefundSalepriceBy11Day();
	int selectSumRefundSalepriceBy12Day();
	...
	int selectAvgSaleSalepriceBy10Day();
	int selectAvgSaleSalepriceBy11Day();
	int selectAvgSaleSalepriceBy12Day();
